  ...
  >
    <div class="mobileCard" on:pointerdown|stopPropagation>
      <div class="mobileSection">
        ...
        <!-- Optional: Put demos here for mobile discovery -->
        <a class="mobileLink" href="/wordle" on:click={closeMenu}>Wordle Solver</a>
        <a class="mobileLink" href="/chat4" on:click={closeMenu}>SQL Chat Demo</a>
      </div>
      ...
      <div class="mobileSection">
        ...
        {/each}
        <a class="mobileLink" href="http://earlmcgowen.info/" target="_blank" rel="noopener noreferrer">
          Legacy Site
        </a>
      </div>
